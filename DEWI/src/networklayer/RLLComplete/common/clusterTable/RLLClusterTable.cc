...
bool RLLClusterTable::addEntry(RLLClusterTableEntry *entry)
{
	...
	{
		throw cRuntimeError(
				"addTable(): cluster entry '%d' already exists in clusterTable",
				entry->getEntryId());
		return false;
	}
...
bool RLLClusterTable::deleteEntry(RLLClusterTableEntry *entry)
{
	...
	if (entry != getEntryById(entry->getEntryId()))
		throw cRuntimeError(
				"deleteEntry(): entry '%d' not found in clusterTable",
				entry->getEntryId());
...
void RLLClusterTable::editEntry(RLLClusterTableEntry *entry)
{
	...
	{
		if (ev.isGUI())
			EV << nodename << "not possible to edit clusterEntry:"
						<< entry->getEntryId() << ". Entry doesn't exist!!!"
						<< "\n";
	...
	if (tmp)
	{
		if (ev.isGUI())
		{
			EV << nodename << ": Cluster Table entry changed: "
						<< entry->getEntryId() << endl;
		}
		entryChanged();
	}
	else
	{
		EV << nodename << ": Cluster Table entry NOTHING changed: "
					<< entry->getEntryId() << endl;
	}
...
RLLClusterTableEntry *RLLClusterTable::getEntry(int pos)
{
	...
	if (pos < 0 || pos > n)
		throw cRuntimeError(
				"getEntry(): clusterEntry index %d out of range 0..%d", pos,
				n - 1);
...
bool RLLClusterTable::existCS(int stage)
{
	for (int i = 0; i < (int) entryTable.size(); i++)
	{
		if (entryTable.at(i)->getStage() == stage
				&& !entryTable.at(i)->getIsCH())
			return true;
	}
	return false;
}
...
channelList RLLClusterTable::generateChannelList(UINT16 address,
		channelList CHList)
{
	...
	if (!entry->getAssignedCL())
	{
		if (entry->getStage() % 2 == 1)
		{
			...
			{
				temp = false;
				tempList.channel2 = entry->getStage() % numChannel + 1
						+ intuniform(0, 16);
				...
				{
					if (entryTable.at(i)->getIsCH()
							&& entryTable.at(i)->getStage() == entry->getStage()
							&& entryTable.at(i) != entry)
					{
						if (tempList.channel2
								== entryTable.at(i)->getChannelList().channel2)
						{
							temp = true;
							break;
						}
			...
			{
				temp = false;
				tempList.channel3 = entry->getStage() % numChannel + 1
						+ intuniform(0, 16);
				...
				for (int i = 0; i < (int) entryTable.size(); i++)
				{
					if (entryTable.at(i)->getIsCH()
							...
							&& entryTable.at(i) != entry)
					{
						if (tempList.channel3
								== entryTable.at(i)->getChannelList().channel3)
						{
							temp = true;
							break;
						}
			...
			{
				temp = false;
				tempList.channel4 = entry->getStage() % numChannel + 1
						+ intuniform(0, 16);
				...
				for (int i = 0; i < (int) entryTable.size(); i++)
				{
					if (entryTable.at(i)->getIsCH()
							...
							&& entryTable.at(i) != entry)
					{
						if (tempList.channel4
								== entryTable.at(i)->getChannelList().channel4)
						{
							temp = true;
							break;
						}
			...
			{
				temp = false;
				tempList.channel7 = entry->getStage() % numChannel + 1
						+ intuniform(0, 16);
				...
				for (int i = 0; i < (int) entryTable.size(); i++)
				{
					if (entryTable.at(i)->getIsCH()
							...
							&& entryTable.at(i) != entry)
					{
						if (tempList.channel7
								== entryTable.at(i)->getChannelList().channel7)
						{
							temp = true;
							break;
						}
			...
			{
				temp = false;
				tempList.channel8 = entry->getStage() % numChannel + 1
						+ intuniform(0, 16);
				...
				for (int i = 0; i < (int) entryTable.size(); i++)
				{
					if (entryTable.at(i)->getIsCH()
							...
							&& entryTable.at(i) != entry)
					{
						if (tempList.channel8
								== entryTable.at(i)->getChannelList().channel8)
						{
							temp = true;
							break;
						}
			...
			tempList.channel9 = CHList.channel9;
			tempList.channel10 = CHList.channel10;

			do
			{
				temp = false;
				tempList.channel11 = entry->getStage() % numChannel + 1
						+ intuniform(0, 16);
				...
				for (int i = 0; i < (int) entryTable.size(); i++)
				{
					if (entryTable.at(i)->getIsCH()
							...
							&& entryTable.at(i) != entry)
					{
						if (tempList.channel11
								== entryTable.at(i)->getChannelList().channel11)
						{
							temp = true;
							break;
						}
		...
		else if (entry->getStage() % 2 == 0)
		{
			...
			{
				temp = false;
				tempList.channel5 = entry->getStage() % numChannel + 1
						+ intuniform(0, 16);
				...
				for (int i = 0; i < (int) entryTable.size(); i++)
				{
					if (entryTable.at(i)->getIsCH()
							...
							&& entryTable.at(i) != entry)
					{
						if (tempList.channel5
								== entryTable.at(i)->getChannelList().channel5)
						{
							temp = true;
							break;
						}
			...
			{
				temp = false;
				tempList.channel6 = entry->getStage() % numChannel + 1
						+ intuniform(0, 16);
				...
				for (int i = 0; i < (int) entryTable.size(); i++)
				{
					if (entryTable.at(i)->getIsCH()
							...
							&& entryTable.at(i) != entry)
					{
						if (tempList.channel6
								== entryTable.at(i)->getChannelList().channel6)
						{
							temp = true;
							break;
						}
			...
			{
				temp = false;
				tempList.channel9 = entry->getStage() % numChannel + 1
						+ intuniform(0, 16);
				...
				for (int i = 0; i < (int) entryTable.size(); i++)
				{
					if (entryTable.at(i)->getIsCH()
							...
							&& entryTable.at(i) != entry)
					{
						if (tempList.channel9
								== entryTable.at(i)->getChannelList().channel9)
						{
							temp = true;
							break;
						}
			...
			{
				temp = false;
				tempList.channel10 = entry->getStage() % numChannel + 1
						+ intuniform(0, 16);
				...
				for (int i = 0; i < (int) entryTable.size(); i++)
				{
					if (entryTable.at(i)->getIsCH()
							...
							&& entryTable.at(i) != entry)
					{
						if (tempList.channel10
								== entryTable.at(i)->getChannelList().channel10)
						{
							temp = true;
							break;
						}
