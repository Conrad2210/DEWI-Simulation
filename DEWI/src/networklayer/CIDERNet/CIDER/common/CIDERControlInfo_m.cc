...
Register_Class(CIDERControlInfo);
...
CIDERControlInfo::~CIDERControlInfo()
{
}

CIDERControlInfo& CIDERControlInfo::operator=(const CIDERControlInfo& other)
{
...
{
  public:
    CIDERControlInfoDescriptor();
    virtual ~CIDERControlInfoDescriptor();
...
Register_ClassDescriptor(CIDERControlInfoDescriptor);

CIDERControlInfoDescriptor::CIDERControlInfoDescriptor() : cClassDescriptor("CIDERControlInfo", "cMessage")
{
}

CIDERControlInfoDescriptor::~CIDERControlInfoDescriptor()
{
}

bool CIDERControlInfoDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<CIDERControlInfo *>(obj)!=NULL;
}

const char *CIDERControlInfoDescriptor::getProperty(const char *propertyname) const
{
...
const char *CIDERControlInfoDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int CIDERControlInfoDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
std::string CIDERControlInfoDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool CIDERControlInfoDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *CIDERControlInfoDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
