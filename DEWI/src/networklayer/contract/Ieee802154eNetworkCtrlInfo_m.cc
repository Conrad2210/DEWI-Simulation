//
// Generated file, do not edit! Created by opp_msgc 4.4 from src/networklayer/contract/Ieee802154eNetworkCtrlInfo.msg.
//
...
const char *Ieee802154eNetworkCtrlInfoDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    return (field>=0 && field<119) ? fieldStructNames[field] : NULL;
}
