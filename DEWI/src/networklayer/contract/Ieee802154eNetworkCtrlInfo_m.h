...
/**
 * Class generated from <tt>src/networklayer/contract/Ieee802154eNetworkCtrlInfo.msg</tt> by opp_msgc.
 * <pre>
 ...
 * 	int			codeList[];
 * 	
 * 	uint8_t		nmbrShortAddrPending;	
 * 	uint8_t		nmbrExtAddrPending;		
 * 	uint64_t	addrList[];
 * 	int			sduLength;
 * 	uint8_t		sdu[];
 * 	uint8_t		ebsn;					
...
#endif // _IEEE802154ENETWORKCTRLINFO_M_H_
