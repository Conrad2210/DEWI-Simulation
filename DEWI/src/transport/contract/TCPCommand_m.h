...
/**
 * Enum generated from <tt>src/transport/contract/TCPCommand.msg</tt> by opp_msgc.
 * <pre>
 * enum TcpCommandCode
 * {
 *     TCP_C_OPEN_ACTIVE = 1;   
...
/**
 * Class generated from <tt>src/transport/contract/TCPCommand.msg</tt> by opp_msgc.
 * <pre>
 * class TCPCommand
 * {
 *     int connId = -1;   
