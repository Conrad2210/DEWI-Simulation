...
{ def_phyCurrentChannel, def_phyChannelsSupported, 0 /*phyTransmitPower - Std 802.15.4-2006 (table 23) page 46*/, 0 /*phyTXPowerTolerance - Std 802.15.4-2011 (table 71) page 156 */, 0 /*phyTXPower - Std 802.15.4-2011 (table 71) page 156 */, def_phyCCAMode, def_phyCurrentPage, 0 /*phyMaxFrameDuration*/, 0 /*phySHRDuration*/, 0 /*phySymbolsPerOctet*/,
		0 /*phyPreambleSymbolLength - used for UWB PHY*/, 0 /*phyUWBDataRatesSupported*/, def_phyCSSLowDataRateSupported, def_phyUWBCoUSupported, def_phyUWBCSSupported, def_phyUWBLCPSupported, 0 /*phyUWBCurrentPulseShape*/, 0 /*phyUWBCoUpulse*/, 0 /*phyUWBCSpulse*/, 0 /*phyUWBLCPWeight1*/, 0 /*phyUWBLCPWeight2*/, 0 /*phyUWBLCPWeight3*/, 0 /*phyUWBLCPWeight4*/, 0 /*phyUWBLCPDelay2*/,
		0 /*phyUWBLCPDelay3*/, 0 /*phyUWBLCPDelay4*/, def_phyRanging, def_phyRangingCrystalOffset, def_phyRangingDPS, def_phyCurrentCode, def_phyNativePRF, def_phyUWBScanBinsPerChannel, def_phyUWBInsertedPreambleInterval, 0 /*phyTXRMARKEROffset*/, 0 /*phyRXRMARKEROffset*/, 0 /*phyRFRAMEProcessingTime*/, 0 /*def_phyCCADuration*/
};
...
void Ieee802154ePhy::handle_PLME_SET_TRX_STATE_request(PHYenum setState)
{
	...
	if (setState != curr_state) // case A: desired state is different from current state
	{
		...
		{
			tmp_state = setState;
			if (((setState == phy_RX_ON) && (curr_state == phy_TX_ON)) || ((setState == phy_TX_ON) && (curr_state == phy_RX_ON)))
			{
...
double Ieee802154ePhy::calcDistFreeSpace()
{
	...
	double interfDistance = pow(waveLength * waveLength * phypib.phyTransmitPower / (16.0 * M_PI * M_PI * minReceivePower), 1.0 / alpha);
