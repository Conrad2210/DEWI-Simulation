...
enum
{
    ...
    NF_PHY_PKT_DISCARDED,   // packet is discarded at the phy layer [SR]
    ...
    NF_LINK_CONFIG_CHANGED,
    NF_LINK_STATE_CHANGED,
    NF_LINK_CREATED,
    NF_LINK_DELETED,
    NF_TEMPLATE_CONFIG_CHANGED,
    NF_TEMPLATE_STATE_CHANGED,
    NF_TEMPLATE_CREATED,
    NF_TEMPLATE_DELETED,
    NF_SLOTFRAME_CONFIG_CHANGED,
    NF_SLOTFRAME_STATE_CHANGED,
    NF_SLOTFRAME_CREATED,
    NF_SLOTFRAME_DELETED,


    // Hopping Sequence List - for Std 802.15.4e-2012
    NF_HOPSEQ_CONFIG_CHANGED, //[SR]
    NF_HOPSEQ_STATE_CHANGED,  //[SR]
    NF_HOPSEQ_CREATED,        //[SR]
    NF_HOPSEQ_DELETED,        //[SR]

    // Elements of Neighbor Information Table - for Std 802.15.4e-2012
    NF_NEIGHBOR_CONFIG_CHANGED, //[SR]
    NF_NEIGHBOR_STATE_CHANGED,  //[SR]
    NF_NEIGHBOR_CREATED,        //[SR]
    NF_NEIGHBOR_DELETED,        //[SR]
