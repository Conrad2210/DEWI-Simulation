...
int updateHListLinke(int oper, HLISTLINK **hlistLink1, HLISTLINK **hlistLink2, IE3ADDR hostid, UINT_8 sn)
{
    HLISTLINK *tmp;
    int ok;
...
int chkAddUpdHListLinke(HLISTLINK **hlistLink1, HLISTLINK **hlistLink2, IE3ADDR hostid, UINT_8 sn)
{
    ...
    i = updateHListLinke(hl_oper_rpl, hlistLink1, hlistLink2, hostid, sn);
    if (i == 0) return 1;
    else if (i == 2) return 2;

    i = addHListLinke(hlistLink1, hlistLink2, hostid, sn);
    if (i == 0) return 0;
    else return 3;
}
