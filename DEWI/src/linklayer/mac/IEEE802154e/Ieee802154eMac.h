...
class INET_API Ieee802154eMac: public WirelessMacBase
{
  ...
  protected:
    ...
    */
    //@{
    virtual void    MCPS_DATA_request(Ieee802154eAddrMode srcAddrMode, Ieee802154eAddrMode dstAddrMode, UINT_16 dstPANId,
    ...
    virtual void    MCPS_DATA_confirm(UINT_8 msduHandle, UINT_64 timestamp, bool rangingReceived, UINT_32 rangingCounterStart,
                                        ...
                                        cPacket* ackPayload);
    virtual void    MCPS_DATA_indication(Ieee802154eAddrMode srcAddrMode, UINT_16 srcPANId, IE3ADDR srcAddr,
...
//    virtual void    MLME_GTS_confirm(GTS_Char_Field gtsCharacteristics, MACenum status);
    ...
    virtual void    MLME_ORPHAN_responce(IE3ADDR orphanAddress, UINT_16 shortAddress, bool associatedMember, UINT_8 securityLevel,
    ...
    virtual void    handle_MLME_POLL_request(Ieee802154eAddrMode coordAddrMode, UINT_16 coordPANId, IE3ADDR coordAddress,
                                            UINT_8 securityLevel, UINT_8 keyIdMode, UINT_64 keySource, UINT_8 keyIndex);
    ...
    */
    ...
    virtual void    handle_MLME_SET_LINK_request(Ieee802154eOperation operation, UINT_16 linkHandle, UINT_8 slotframeHandle,
                                            ...
                                            MACTSCHLinkType linkType, UINT_16 nodeAddr);
