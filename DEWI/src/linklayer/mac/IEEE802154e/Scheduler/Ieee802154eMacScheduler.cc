...
#include "Ieee802154eMacScheduler.h"

Define_Module(Ieee802154eMacScheduler);

Ieee802154eMacScheduler::Ieee802154eMacScheduler()
{
...
void Ieee802154eMacScheduler::initialize(int stage)
{
...
void Ieee802154eMacScheduler::handleMessage(cMessage *msg)
{
    if(!isOperational)
    {
...
void Ieee802154eMacScheduler::handleSelfMsg(cMessage *msg)
{
    switch(msg->getKind())
    {
...
void Ieee802154eMacScheduler::handleLowerMsg(cPacket *msg)
{
    //[SR] old version
    bool noAck;
    int i = 0;
...
void Ieee802154eMacScheduler::handleSchedulerMsg(cMessage *msg)
{
    switch(msg->getKind())
    {
...
void Ieee802154eMacScheduler::handle_MLME_ASSOCIATE_request(cMessage *msg)
{
...
void Ieee802154eMacScheduler::MLME_ASSOCIATE_indication(cMessage *msg)
{
...
void Ieee802154eMacScheduler::handle_MLME_ASSOCIATE_response(cMessage *msg)
{
...
void Ieee802154eMacScheduler::MLME_ASSOCIATE_confirm(cMessage *msg)
{
    Ieee802154eAssociationFrame *tmp = check_and_cast<Ieee802154eAssociationFrame *>(msg);
...
void Ieee802154eMacScheduler::handle_MLME_DISASSOCIATE_request(cMessage *msg)
{
...
void Ieee802154eMacScheduler::MLME_DISASSOCIATE_indication(cMessage *msg)
{
    ...
    send(tmpMsg, mSchedulerOut);
}

void Ieee802154eMacScheduler::handle_MLME_DISASSOCIATE_response(cMessage *msg)
{
    Ieee802154eDisassociationFrame *tmpMsg = check_and_cast<Ieee802154eDisassociationFrame *>(msg);
...
void Ieee802154eMacScheduler::MLME_DISASSOCIATE_confirm(cMessage *msg)
{
    Ieee802154eDisassociationFrame * tmpMsg = check_and_cast<Ieee802154eDisassociationFrame *>(msg);
    ...
    send(tmpMsg->dup(), mSchedulerOut);
    delete tmpMsg;
}

void Ieee802154eMacScheduler::MLME_BEACON_NOTIFY_indication(cMessage *msg)
{
    if(dynamic_cast<Ieee802154EnhancedBeaconFrame *>(msg) && isPANCoor)
    {
	msg->setKind(TP_MLME_BEACON_NOTIFY_INDICATION);
	send(msg, mSchedulerOut);
    }
    else
    {
...
void Ieee802154eMacScheduler::handle_MLME_SCAN_request(cMessage *msg)
{
...
void Ieee802154eMacScheduler::MLME_SCAN_confirm(cMessage *msg)
{
    ...
    send(frame, mSchedulerOut);
}

void Ieee802154eMacScheduler::handle_MLME_START_request(cMessage *msg)
{
...
void Ieee802154eMacScheduler::MLME_START_confirm(MACenum status)
{
...
void Ieee802154eMacScheduler::handle_MLME_BEACON_request(cMessage *msg)
{
    //constructBCN();
    //constructBCN();
    txBeaconNow = true;
...
void Ieee802154eMacScheduler::MLME_BEACON_confirm(MACenum status)
{
    Ieee802154eNetworkCtrlInfo *primitive = new Ieee802154eNetworkCtrlInfo();
...
void Ieee802154eMacScheduler::handle_MLME_SET_SLOTFRAME_request(cMessage *msg)
{
    handleEB(msg->dup());
    delete msg;
}
...
void Ieee802154eMacScheduler::handle_SCHEDULE_request(cMessage *msg)
{
...
void Ieee802154eMacScheduler::SCHEDULE_indication(cMessage *msg)
{
    if(dynamic_cast<Ieee802154eMulHoCluFrame *>(msg))
        {
...
void Ieee802154eMacScheduler::handle_SCHEDULE_response(cMessage *msg)
{
    Ieee802154eNetworkCtrlInfo *tmpNetCn;
           if(dynamic_cast<Ieee802154eMulHoCluFrame *>(msg))
           {
...
void Ieee802154eMacScheduler::SCHEDULE_confirm(cMessage *msg, bool ack)
{
    if(dynamic_cast<Ieee802154eMulHoCluFrame *>(msg))
        {
...
//Multihop CLustering
void Ieee802154eMacScheduler::handle_RESTART_request(cMessage *msg)
{
...
void Ieee802154eMacScheduler::RESTART_confirm(cMessage *msg)
{
    send(msg->dup(), mSchedulerOut);
    delete msg;
}

void Ieee802154eMacScheduler::handleAwaitingBeaconTimer()
{
    awaitingNextBeacon = false;
}

void Ieee802154eMacScheduler::handleEB(cMessage *msg)
{
...
void Ieee802154eMacScheduler::handleAck(Ieee802154eFrame* frame) // TODO: include the 802.15.4e Ack Frame [SR]
{
...
void Ieee802154eMacScheduler::handleAsnTimer()
...
void Ieee802154eMacScheduler::handleTsAckWait()
{
