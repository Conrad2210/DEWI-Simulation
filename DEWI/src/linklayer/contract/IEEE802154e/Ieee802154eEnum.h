...
enum t_mac_states
{
	IDLE_1 = 1, BACKOFF_2, CCA_3, TRANSMITFRAME_4, WAITACK_5, WAITSIFS_6, TRANSMITACK_7

};

enum t_mac_status
{
	STATUS_OK = 1, STATUS_ERROR, STATUS_RX_ERROR, STATUS_RX_TIMEOUT, STATUS_FRAME_TO_PROCESS, STATUS_NO_FRAME_TO_PROCESS, STATUS_FRAME_TRANSMITTED
};

//TSCH LINK Type
typedef enum
{
	LNK_TP_NORMAL = 0, LNK_TP_ADVERTISING = 1, LNK_TP_JOIN = 2,     // [CD] copied from the openWSN
...
{
	PHY_CCA_TIMER, PHY_ED_TIMER, PHY_TRX_TIMER, PHY_TX_OVER_TIMER, PHY_RX_OVER_TIMER               // dynamic timer
};

// packet error type
enum Ieee802154ePktErrorType   // for msgKind set by PHY layer
{
	PACKETOK = 0, BITERROR_FORCE_TRX_OFF, RX_DURING_CCA                   // pkts received during CCA need to be discarded
};
...
typedef enum
{
	EAckIE_LST_NONE = 0, EAckIE_LST_SHORT = 1, EAckIE_LST_FULL = 2
...
typedef enum
{
	SF_OP_ADD = 0, SF_OP_DELETE = 1, SF_OP_MODIFY = 2
} Ieee802154eSlotframeOperation;

// TSCH Slotframe - Status type - Std 802.15.4e-2012 (table 44e) page 145
typedef enum
{
	SF_STATUS_SUCCESS = 0, SF_STATUS_INVALID_PARAMETER = 1, SF_STATUS_SLOTFRAME_NOT_FOUND = 2, SF_STATUS_MAX_SLOTFRAMES_EXCEEDED = 3
} Ieee802154eSlotframeStatus;

// TSCH Set Link - Operation type - Std 802.15.4e-2012 (table 44d) page 144
typedef enum
{
	LNK_OP_ADD_LINK = 0, LNK_OP_DELETE_LINK = 1, LNK_OP_MODIFY_MODIFY_LINK = 2
...
typedef enum
{
	LNK_STATUS_SUCCESS = 0, LNK_STATUS_INVALID_PARAMETER = 1, LNK_STATUS_UNKNOWN_LINK = 2, LNK_STATUS_MAX_LINKS_EXCEEDED = 3
} Ieee802154eLinkStatus;

// TSCH Mode - TSCHMode type - Std 802.15.4e-2012 (table 44h) page 147
typedef enum
{
	TSCH_MODE_OFF = 0, TSCH_MODE_ON = 1
} Ieee802154eTSCHMode;

// TSCH Mode - TSCHMode Status type - Std 802.15.4e-2012 (table 44i) page 148
typedef enum
{
	TSCH_MODE_STATUS_SUCCESS = 0, TSCH_MODE_STATUS_NO_SYNC = 1
} Ieee802154eTSCHModeStatus;

// TSCH KEEP ALIVE - Status type - Std 802.15.4e-2012 (table 44i) page 148
typedef enum
{
	KA_STATUS_SUCCESS = 0, KA_STATUS_INVALID_PARAMETER = 1
...
typedef enum
{
	...
	Ieee802154e_ASSOCIATION_RESPONSE = 8,
	Ieee802154e_SCHEDULER_REQUEST = 9,
	Ieee802154e_SCHEDULER_RESPONSE = 10,
	Ieee802154e_DISASSOCIATION_REQUEST = 11,
	Ieee802154e_DISASSOCIATION_RESPONSE = 12
...
typedef enum
{
	...
	TP_RESTART_REQUEST,
	TP_RESTART_CONFIRM,
	TP_BEACON_SCAN_REQUEST,
	TP_BEACON_SCAN_CONFIRM
...
typedef enum
{
	DNC_COORD_W_DEVICE_L_PAN = 0x01, DNC_DEVICE_W_L_PAN = 0x02
} Ieee802154eDNCType;
...
typedef enum
{
	Ieee802154_2003_compatible = 0x00, Ieee802154_2006_introduced = 0x01, Ieee802154_compatible = 0x02
...
typedef enum
{
	AddrMode_NO_ADRESS = 0x00, AddrMode_SIMPLE_ADDRESS = 0x01, // Std 802.15.4e-2012 (table 46) page 168
...
typedef enum
{
	UWBPRF_PRF_OFF = 0, UWBPRF_NOMINAL_4_M = 1, UWBPRF_NOMINAL_16_M = 2, UWBPRF_NOMINAL_64_M = 3
...
typedef enum
{
	BeaconType_BEACON = 0, BeaconType_ENHANCED_BEACON = 1

} Ieee802154eBeaconType;

typedef enum
{
	OP_ADD = 0, OP_DELETE = 1, OP_MODIFY = 2, OP_ADD_LINK = 3, OP_DELETE_LINK = 4, OP_MODIFY_LINK = 5
